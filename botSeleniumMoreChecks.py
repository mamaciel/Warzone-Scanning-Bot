...
driver = webdriver.Chrome(executable_path=r"C:/Users/marco/Documents/Warzone Kill Bot/chromedriver.exe")
from selenium.webdriver.common.by import By
import mss
import mss.tools

pytesseract.tesseract_cmd = r'C:\Users\marco\AppData\Local\Programs\Tesseract-OCR\tesseract.exe'
...
def runCrappyCode():
    ...
    while not found:
        ...
        coords3 = pyautogui.locateOnScreen('4ex.png', confidence = 0.24, grayscale = True, region = (696, 938, 339, 36))
        coords4 = pyautogui.locateOnScreen('5ex.png', confidence = 0.24, grayscale = True, region = (696, 938, 339, 36))
        coords5 = pyautogui.locateOnScreen('6ex.png', confidence = 0.24, grayscale = True, region = (696, 938, 339, 36))
        coords6 = pyautogui.locateOnScreen('7ex.png', confidence = 0.24, grayscale = True, region = (696, 938, 339, 36))
        coords7 = pyautogui.locateOnScreen('8ex.png', confidence = 0.24, grayscale = True, region = (696, 938, 339, 36))
        coords8 = pyautogui.locateOnScreen('11ex.png', confidence = 0.24, grayscale = True, region = (696, 938, 339, 36))
        coords9 = pyautogui.locateOnScreen('13ex.png', confidence = 0.24, grayscale = True, region = (696, 938, 339, 36))
        
        elapsed = time.time() - t
        #print(elapsed)
        if coords or coords1 or coords2 or coords3 or coords4 or coords5 or coords6 or coords7 or coords8 or coords9:
            t = time.time()
            with mss.mss() as sct:
